 ...
 * @author Rafael
 */
public class TelaPrincipalInterlPane extends javax.swing.JFrame {
     ...
     */
    public TelaPrincipalInterlPane() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaPrincipalInterlPane.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaPrincipalInterlPane().setVisible(true);
            }
        });
    }
